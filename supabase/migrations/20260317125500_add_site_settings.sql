CREATE TABLE IF NOT EXISTS public.site_settings (
  ...
  site_name text NOT NULL DEFAULT 'LINUXDO-模型中转状态检测',
  ...
  hero_title_primary text NOT NULL DEFAULT 'LINUXDO',
  hero_title_secondary text NOT NULL DEFAULT '模型中转状态检测',
  ...
  footer_brand text NOT NULL DEFAULT 'LINUXDO-模型中转状态检测',
